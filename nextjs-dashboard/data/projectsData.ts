export type Project = {
  ...
  export const projectsData: Project[] = [
    ...
    },
    {
      ...
      description: `
      This project was a guiding principle for learning the Laravel framework. It interacts
with a database and allows CRUD and permission management, and manages access restrictions based on user rights. It also manages an account creation and login system.
      `,
