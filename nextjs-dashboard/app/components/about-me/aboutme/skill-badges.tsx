...
const skillIcons = {
  ...
  GitHub: <FaGithub className="text-gray-800 dark:text-gray-300" />,
...
const SkillMedal: React.FC<SkillMedalProps> = ({ skill }) => {
  return (
    <div className="w-16 h-16 flex items-center justify-center bg-gray-200 dark:bg-gray-800 rounded-full shadow-md border-2 border-gray-300 dark:border-gray-600 transition-colors duration-300">
      {skillIcons[skill] || <FaDatabase className="text-gray-800 dark:text-white" />}
    </div>
  );
};
