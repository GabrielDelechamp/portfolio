export default function Footer() {
    return (
        <footer className="h-[6vh]">
            <hr className="border-[#1E2D3D]" />
            <div className="flex items-center justify-between">
                <span className="flex items-center">
                    <p className="px-[40px]">Find me on :</p>
                    <a href="" className="items-center flex  px-[10px]  h-[5.7vh] border-r-2 border-l-2 border-[#1E2D3D]">
                ...
                <span className="flex items-center border-l-2 border-[#1E2D3D]">
                    <a href="https://github.com/GabrielDelechamp" target="_blank" className="flex items-center px-[40px]">
                        <p className="py-[17px] px-[40px]">@GabrielDelechamp</p>
